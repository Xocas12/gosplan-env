...
| M3 | Species maps 2017 and 2024, areas, 2017→2024 conversion | done: cleaned OSM labels plus harvest-history pseudo-labels, held-out-north eucalyptus F1 0.72; 2017 normalised and backdated from 2024 (≈489k ha 2017, 440k ha 2024); checked against ~6,900 IFN3 plots from GBIF (area right in aggregate, plot-level F1 0.45); Landsat back-cast built but fails validation (TOA Level-1 only) |
